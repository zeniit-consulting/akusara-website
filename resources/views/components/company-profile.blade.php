<section id="company-profile" class="scroll-mt-10 py-20 px-6 bg-[#1800AD]">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-16">
            <!-- Vision -->
            <div class="bg-white/10 border border-white/30 rounded-2xl p-8 backdrop-blur-lg" data-aos="fade-up"
                data-aos-duration="900" data-aos-delay="100">
                <div class="mb-4 w-12 h-12 rounded-full bg-white/20 flex items-center justify-center">
