<section id="about" class="scroll-mt-20 py-20 px-6 bg-white">
    <div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
        ...
        <div data-aos="fade-right" data-aos-duration="900" data-aos-delay="100">
            ...
            @php
                $text = ucwords(strtolower($setting->about_title ?? 'About Us'));
                $words = explode(' ', $text);
                $last = array_pop($words);
            @endphp

            <h2 class="text-3xl md:text-4xl font-bold mb-4  text-gray-800" data-aos="fade-up"
            ...
            <p class="text-slate-600 leading-relaxed" data-aos="fade-up" data-aos-duration="900" data-aos-delay="250">
                {{ ucfirst(strtolower($setting->about_description ?? 'Default description goes here. You can update this content from the settings page.')) }}
            </p>
        </div>
        ...
        <div class="rounded-2xl overflow-hidden shadow-xl" data-aos="fade-left" data-aos-duration="900"
            data-aos-delay="200">
            <img src="{{ asset('storage/' .$setting->about_image)  }}" alt="About Look Creative"
