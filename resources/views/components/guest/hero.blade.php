<section id="home"
    ...
    style="background-image: linear-gradient(180deg, rgba(24,0,173,0.85) 0%, rgba(18,0,133,0.85) 50%, rgba(5,1,34,0.7) 100%), url('{{ asset('images/hero-bg.jpg') }}'); background-size: cover; background-position: center;">
    ...
    <div class="relative z-10 max-w-3xl px-4 py-10 text-center">
        ...
        <p class="text-slate-200 max-w-xl mx-auto mb-8 text-lg md:text-xl leading-relaxed" data-aos="fade-up"
            ...
            Your best partner to <span class="font-semibold text-white">grow your business</span> with bold digital
            experiences.
        </p>
