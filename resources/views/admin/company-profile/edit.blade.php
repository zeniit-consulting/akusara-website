        ...
        <div class="mx-auto max-w-5xl space-y-6">
            <div class="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
                <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div>
                        <h1 class="text-3xl font-semibold text-slate-900">Edit Company Profile</h1>
                        <p class="mt-2 text-sm text-slate-500">Edit detail profil perusahaan.</p>
                    </div>
            ...
            <form method="POST" action="{{ route('admin.company-profile.update', $companyProfile->id) }}"
                ...
                <div class="space-y-6">
                    <section class="space-y-5 rounded-3xl border border-slate-200 bg-slate-50 p-6">
                        <div>
                            ...
                            <p class="mt-2 text-sm text-slate-500">Edit detail profil perusahaan Anda.</p>
                        </div>
                        ...
                        <div>
                            ...
                            <x-text-input id="company_profile_title" name="company_profile_title" type="text"
                                ...
                                :value="old('company_profile_title', $companyProfile->company_profile_title)" placeholder="Enter company title" />
                        ...
                        <div>
                            ...
                            <textarea id="company_profile_description" name="company_profile_description" rows="6"
                                ...
                                placeholder="Write the company description">{{ old('company_profile_description', $companyProfile->company_profile_description) }}</textarea>
                        ...
                        <div>
                            ...
                            <x-text-input id="company_profile_vision" name="company_profile_vision" type="text"
                                class="mt-1 block w-full rounded-2xl border-slate-300 bg-white px-4 py-3 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                :value="old('company_profile_vision', $companyProfile->company_profile_vision)" placeholder="Enter company vision" />
                        ...
                        <div>
                            ...
                            <x-text-input id="company_profile_mission" name="company_profile_mission" type="text"
                                class="mt-1 block w-full rounded-2xl border-slate-300 bg-white px-4 py-3 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                :value="old('company_profile_mission', $companyProfile->company_profile_mission)" placeholder="Enter company mission" />
                        ...
                        <div>
                            ...
                            <x-text-input id="company_profile_values" name="company_profile_values" type="text"
                                class="mt-1 block w-full rounded-2xl border-slate-300 bg-white px-4 py-3 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                :value="old('company_profile_values', $companyProfile->company_profile_values)" placeholder="Enter company values" />
                    ...
                    <div class="flex flex-col gap-4 rounded-3xl border border-slate-200 bg-slate-50 p-6">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-slate-500">Simpan perubahan atau batalkan editing.</p>
                        </div>
