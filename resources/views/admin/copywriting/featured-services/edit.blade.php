        ...
        <div class="mx-auto max-w-5xl space-y-6">
            <div class="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
                <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div>
                        <h1 class="text-3xl font-semibold text-slate-900">Edit Featured Service</h1>
                    </div>
            ...
            <form method="POST" action="{{ route('admin.featured-services.update', $featuredService->id) }}"
                    ...
                    <section class="space-y-5 rounded-3xl border border-slate-200 bg-slate-50 p-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="featured_services_title" name="featured_services_title" type="text"
                                ...
                                :value="old('featured_services_title', $featuredService->featured_services_title)" placeholder="Enter featured service title" />
                        ...
                        <div>
                            ...
                            <textarea id="featured_services_description" name="featured_services_description" rows="8"
                                ...
                                placeholder="Write the featured service description">{{ old('featured_services_description', $featuredService->featured_services_description) }}</textarea>
