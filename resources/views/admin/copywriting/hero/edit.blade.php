    ...
    <div class="bg-white shadow-sm rounded-2xl border border-gray-200 overflow-hidden">
        <div class="px-6 py-6 border-b border-gray-200">
            <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">Update the hero section content for your website.</p>
                </div>
        ...
        <form method="POST" action="{{ route('admin.hero.update', $hero->id) }}" enctype="multipart/form-data"
            ...
            <section class="space-y-4 rounded-2xl border border-gray-200 bg-slate-50 p-6">
                ...
                <div>
                    ...
                    <x-text-input id="hero_title" name="hero_title" type="text" class="mt-1 block w-full"
                        :value="old('hero_title', $hero->hero_title)" placeholder="Main headline for your hero section" />
                ...
                <div>
                    ...
                    <textarea id="hero_description" name="hero_description" rows="5"
                        ...
                        placeholder="Supporting description for the hero section">{{ old('hero_description', $hero->hero_description) }}</textarea>
            ...
            <div class="flex flex-col gap-3 pt-6 border-t border-gray-200 sm:flex-row sm:justify-end">
                ...
                <x-primary-button class="w-full sm:w-auto">Update Hero Section</x-primary-button>
            </div>
        </form>
    </div>
