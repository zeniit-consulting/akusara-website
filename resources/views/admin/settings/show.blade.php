<x-app-layout>
    <div class="p-6 max-w-6xl mx-auto space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow p-6 space-y-4">
            ...
            <div>
                <label class="block text-sm text-gray-500 mb-1">Hero Title</label>
                <input type="text" value="{{ $setting->hero_title }}"
                    class="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2" disabled>
            </div>

            <div>
                <label class="block text-sm text-gray-500 mb-1">Hero Description</label>
                <textarea rows="3" class="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2" disabled>{{ $setting->hero_description }}</textarea>
            </div>

            @if ($setting->hero_image)
                <div>
                    <label class="block text-sm text-gray-500 mb-2">Hero Image</label>
                    <img src="{{ asset('storage/' . $setting->hero_image) }}" class="w-48 rounded-xl border">
                </div>
            @endif
        </div>
        ...
        <div class="bg-white rounded-2xl shadow p-6 space-y-4">
            ...
            <div>
                <label class="block text-sm text-gray-500 mb-1">About Title</label>
                <input type="text" value="{{ $setting->about_title }}"
                    class="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2" disabled>
            </div>

            <div>
                <label class="block text-sm text-gray-500 mb-1">About Description</label>
                <textarea rows="3" class="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2" disabled>{{ $setting->about_description }}</textarea>
            </div>

            @if ($setting->about_image)
                <div>
                    <label class="block text-sm text-gray-500 mb-2">About Image</label>
                    <img src="{{ asset('storage/' . $setting->about_image) }}" class="w-48 rounded-xl border">
                </div>
            @endif
        </div>
        ...
        <div class="bg-white rounded-2xl shadow p-6 space-y-4">
            ...
            <div>
                <label class="block text-sm text-gray-500 mb-1">Services Title</label>
                <input type="text" value="{{ $setting->services_title }}"
                    class="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2" disabled>
            </div>

            <div>
                <label class="block text-sm text-gray-500 mb-1">Services Description</label>
                <textarea rows="3" class="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2" disabled>{{ $setting->services_description }}</textarea>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow p-6 space-y-4">
            ...
            <div>
                ...
                <input type="text" value="{{ $setting->company_profile_title }}"
                    class="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2" disabled>
            </div>

            <div>
                <label class="block text-sm text-gray-500 mb-1">Description</label>
                <textarea rows="3" class="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2" disabled>{{ $setting->company_profile_description }}</textarea>
            </div>

            <div class="grid md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm text-gray-500 mb-1">Vision</label>
                    <textarea rows="3" class="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2" disabled>{{ $setting->company_profile_vision }}</textarea>
                </div>

                <div>
                    <label class="block text-sm text-gray-500 mb-1">Mission</label>
                    <textarea rows="3" class="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2" disabled>{{ $setting->company_profile_mission }}</textarea>
                </div>
            </div>

            <div>
                <label class="block text-sm text-gray-500 mb-1">Values</label>
                <textarea rows="3" class="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2" disabled>{{ $setting->company_profile_values }}</textarea>
            </div>
        </div>
